...
public static class PlanetGravity
{
    ...
    {if(FSPDebuger.EnableLogTrackInternal)FSPDebuger.LogTrack(56, (int)surfaceGravity, (int)planetRadius);
    ...
    {if(FSPDebuger.EnableLogTrackInternal)FSPDebuger.LogTrack(57, (int)distance, (int)gravitationalParameter);
    ...
    {if(FSPDebuger.EnableLogTrackInternal)FSPDebuger.LogTrack(58, (int)gravitationalParameter);
    ...
    {if(FSPDebuger.EnableLogTrackInternal)FSPDebuger.LogTrack(61);
