...
public static class VoxelQuadSphereTerrain
{
    ...
    public static byte GenerateVoxel(
        ...
        float planetRadius)
    {if(FSPDebuger.EnableLogTrackInternal)FSPDebuger.LogTrack(110, (int)cellU, (int)cellV, (int)depth, (int)gridSize, (int)maxDepth, (int)innerSolidDepthLayers, (int)seed);
