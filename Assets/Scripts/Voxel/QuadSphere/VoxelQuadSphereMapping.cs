...
public static class VoxelQuadSphereMapping
{
    ...
    {if(FSPDebuger.EnableLogTrackInternal)FSPDebuger.LogTrack(90, (int)u, (int)v);
    ...
    {if(FSPDebuger.EnableLogTrackInternal)FSPDebuger.LogTrack(92, (int)cellU, (int)cellV, (int)gridSize);
    ...
    {if(FSPDebuger.EnableLogTrackInternal)FSPDebuger.LogTrack(93, (int)cellU, (int)cellV, (int)depth, (int)gridSize, (int)planetRadius);
    ...
    public static CellHalfExtents GetCellHalfExtents(
        ...
        float planetRadius,
        Vector3 planetCenter)
    {if(FSPDebuger.EnableLogTrackInternal)FSPDebuger.LogTrack(94, (int)cellU, (int)cellV, (int)depth, (int)gridSize, (int)maxDepth, (int)planetRadius);
    ...
    {if(FSPDebuger.EnableLogTrackInternal)FSPDebuger.LogTrack(95, (int)cellU, (int)cellV, (int)gridSize);
    ...
    public static void GetCellBasis(
        ...
        out Vector3 right,
        out Vector3 forward)
    {if(FSPDebuger.EnableLogTrackInternal)FSPDebuger.LogTrack(96, (int)cellU, (int)cellV, (int)gridSize);
        float u = CellToNormalized(cellU, gridSize);
        float v = CellToNormalized(cellV, gridSize);
    ...
    public static QuadSphereVoxelAddress RemapAcrossFace(
        ...
        int gridSize)
    {if(FSPDebuger.EnableLogTrackInternal)FSPDebuger.LogTrack(98, (int)gridSize);
    ...
    {if(FSPDebuger.EnableLogTrackInternal)FSPDebuger.LogTrack(99, (int)planetRadius, (int)gridSize, (int)maxDepth);
